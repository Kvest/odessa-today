...
public class MainMenuAdapter extends BaseAdapter {
    ...
    private static final MainMenuItem[] items = {
            ...
            new SubcategoryItem(MainMenuFragment.MENU_CONCERT_ID, R.string.menu_concert, R.drawable.ic_menu_concert, true),
            new SubcategoryItem(MainMenuFragment.MENU_PARTY_ID, R.string.menu_party, R.drawable.ic_menu_party, true),
            new SubcategoryItem(MainMenuFragment.MENU_SPECTACLE_ID, R.string.menu_spectacle, R.drawable.ic_menu_spectacle, true),
            ...
            new SubcategoryItem(MainMenuFragment.MENU_CONCERT_HALL_ID, R.string.menu_concert_hall, R.drawable.ic_menu_concert_hall, true),
            new SubcategoryItem(MainMenuFragment.MENU_CLUB_ID, R.string.menu_club, R.drawable.ic_menu_club, true),
            new SubcategoryItem(MainMenuFragment.MENU_MUSEUM_ID, R.string.menu_museum, R.drawable.ic_menu_museum, true),
            new SubcategoryItem(MainMenuFragment.MENU_GALLERY_ID, R.string.menu_gallery, R.drawable.ic_menu_gallery, true),
            new SubcategoryItem(MainMenuFragment.MENU_ZOO_ID, R.string.menu_zoo, R.drawable.ic_menu_zoo, true),
            new SubcategoryItem(MainMenuFragment.MENU_QUEST_ID, R.string.menu_quest, R.drawable.ic_menu_quest, true),
            new SubcategoryItem(MainMenuFragment.MENU_RESTAURANT_ID, R.string.menu_restaurant, R.drawable.ic_menu_restaurant, true),
            new SubcategoryItem(MainMenuFragment.MENU_CAFE_ID, R.string.menu_cafe, R.drawable.ic_menu_cafe, true),
            new SubcategoryItem(MainMenuFragment.MENU_PIZZA_ID, R.string.menu_pizza, R.drawable.ic_menu_pizza, true),
            new SubcategoryItem(MainMenuFragment.MENU_SUSHI_ID, R.string.menu_sushi, R.drawable.ic_menu_sushi, true),
            new SubcategoryItem(MainMenuFragment.MENU_KARAOKE_ID, R.string.menu_karaoke, R.drawable.ic_menu_karaoke, true),
            new SubcategoryItem(MainMenuFragment.MENU_SKATING_RINK_ID, R.string.menu_skating_rink, R.drawable.ic_menu_skating_rink, true),
            new SubcategoryItem(MainMenuFragment.MENU_BOWLING_ID, R.string.menu_bowling, R.drawable.ic_menu_bowling, true),
            new SubcategoryItem(MainMenuFragment.MENU_BILLIARD_ID, R.string.menu_billiard, R.drawable.ic_menu_billiard, true),
            new SubcategoryItem(MainMenuFragment.MENU_SAUNA_ID, R.string.menu_sauna, R.drawable.ic_menu_sauna, true),
            new SubcategoryItem(MainMenuFragment.MENU_BATH_ID, R.string.menu_bath, R.drawable.ic_menu_bath, true)
    };
